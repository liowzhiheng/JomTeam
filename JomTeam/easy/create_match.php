...
<body>
    ...
    <div class="profile-content">
        ...
        <p class="profile-description">
            Not finding the right match?<br>No problem! Create your own game-changing partnership and turn any challenge
        ...
        <div class="profile-container">
            ...
            <div class="profile-right">
                ...
                <form id="profileForm" action="update_profile.php" method="post">
                    ...
                    <div class="group">
                        <label for="status">Number of people allowed:</label>
